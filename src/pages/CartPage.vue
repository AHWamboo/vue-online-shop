        ...
        <q-card class="q-mt-md">
          <q-list bordered>
            ...
            <q-expansion-item icon="local_shipping" label="Delivery policy">
              <q-card>
                <q-card-section>
                  We offer standard delivery within 3-5 business days and
                  express delivery within 1-2 business days.
                  <a href="#" class="text-primary">Shipping costs</a> vary by
                  destination and order value. Free shipping is available for
                  orders over $50. International orders may take 7-14 business
                  days. We are not responsible for delays caused by customs or
                  weather conditions. Tracking information will be provided via
                  email automatically. Returns must be initiated within 30 days
                  of delivery date.
                </q-card-section>
              </q-card>
            </q-expansion-item>
